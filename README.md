...
```bash
npm test          # 261 checks, Node, no browser
...
third". A default frame is around 29 passes ordered from 41 dependency edges; the exact count moves
...
normalized accessors, sparse accessors, and generated tangents. Not skins or morph targets.
